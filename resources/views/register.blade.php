                ...
                <div class="w-1/2 p-5 pl-10 ">
                    ...
                    <form class="mt-4">
                        <div class="mb-4">
                            ...
                            <input class="w-full px-3 py-2 text-black rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500" type="email" id="email" placeholder="Enter your email" required>
                        </div>
                        <div class="mb-4">
