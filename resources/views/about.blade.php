      ...
      <section class="max-w-screen-xl mx-auto my-8 p-4">
        <div class="bg-white p-6 rounded-lg shadow-lg flex">
           ...
           <div class="w-2/3">
              ...
              <p class="text-xl text-gray-700 font-semibold mb-4">Rp {{ number_format($product->price_product, 0, ',', '.') }}</p>
              <button class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" id="add-to-cart-btn">Buy now!</button>
           </div>
           @endforeach
        </div>
        <div id="popup" class="popup rounded-lg bg-white p-8 w-1/4 shadow-2xl absolute bottom-0 left-0 right-0 mx-auto hidden">
